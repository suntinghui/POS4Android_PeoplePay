...
public class ShowActivity extends BaseActivity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (index) {
		case 0:// 彩票
			resIds = new int[] { R.drawable.lotteryticket_1, R.drawable.lotteryticket_2, R.drawable.lotteryticket_3, R.drawable.lotteryticket_4, R.drawable.lotteryticket_5, };
			break;
		case 1:// 游戏点卡
			resIds = new int[] { R.drawable.game_1, R.drawable.game_2, R.drawable.game_3 };
			break;
		case 2:
			resIds = new int[] { R.drawable.taxi_1, R.drawable.taxi_2, R.drawable.taxi_3 };
			break;
		case 3:
			resIds = new int[] { R.drawable.flights_1, R.drawable.flights_2, R.drawable.flights_3, R.drawable.flights_4, R.drawable.flights_5, R.drawable.flights_6 };
			break;
		case 4:
			resIds = new int[] { R.drawable.fixed_1, R.drawable.fixed_2, R.drawable.fixed_3 };
			break;
		case 5:
			resIds = new int[] { R.drawable.qq_1, R.drawable.qq_2, R.drawable.qq_3, R.drawable.qq_4, R.drawable.qq_5 };
			break;
		case 6:
			resIds = new int[] { R.drawable.card_1, R.drawable.card_2, R.drawable.card_3, R.drawable.card_4, R.drawable.card_5 };
			break;
		case 7:
			resIds = new int[] { R.drawable.phone_1, R.drawable.phone_2, R.drawable.phone_3 };
			break;
		case 8:
			resIds = new int[] { R.drawable.donate_1, R.drawable.donate_2, R.drawable.donate_3, R.drawable.donate_4, R.drawable.donate_5, R.drawable.donate_6 };
			break;
