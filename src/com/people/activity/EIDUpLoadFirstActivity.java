...
// 基本信息
public class EIDUpLoadFirstActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_eid_upload_first);
	...
	public void onClick(View v) {
		...
		case R.id.btn_confirm:
			Intent intent_c = new Intent(EIDUpLoadFirstActivity.this, EIDUpLoadSecondActivity.class);
			startActivityForResult(intent_c, 10);
			break;
		case R.id.btn_back:
			this.finish();
			break;
		case R.id.btn_bank_branch:
			Intent intent_b = new Intent(this, BankBranchActivity.class);
			...
			public void successAction(Object obj) {
				...
				if ("00".equals(recieveMap.get("RSPCOD"))) {
					...
					if (provices != null && provices.size() != 0) {
						ArrayAdapter<Province> provinceAdapter = new ArrayAdapter<Province>(EIDUpLoadFirstActivity.this, R.layout.simple_spinner_item, android.R.id.text1, provices);
			...
			public void successAction(Object obj) {
				...
				if ("00".equals(recieveMap.get("RSPCOD"))) {
					...
					if (cities != null && cities.size() != 0) {
						...
						ArrayAdapter<CityModel> cityAdapter = new ArrayAdapter<CityModel>(EIDUpLoadFirstActivity.this, R.layout.simple_spinner_item, android.R.id.text1, cities);
			...
			public void successAction(Object obj) {
				...
				if ("00".equals(recieveMap.get("RSPCOD"))) {
					...
					if (banks != null && banks.size() != 0) {
						...
						ArrayAdapter<Bank> bankAdapter = new ArrayAdapter<Bank>(EIDUpLoadFirstActivity.this, R.layout.simple_spinner_item, android.R.id.text1, banks);
